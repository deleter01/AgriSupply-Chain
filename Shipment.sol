...
contract ShipmentContract {
    ...
    function startShipment(address _sender, address _receiver, uint256 _index) public {
        ...
        require(shipment.status == ShipmentStatus.PENDING, "The Shipment ready in Transit");
    ...
    function completeShipment(address _sender, address _receiver, uint256 _index) public {
        ...
        require(shipment.receiver == _receiver, "Invalid Receiver");
        require(shipment.status == ShipmentStatus.IN_TRANSIT, "The Shipment not in Transit");
    ...
    function getShipment(address _sender, uint256 _index) public view returns (address, address, uint256, uint256, uint256, uint256, ShipmentStatus, bool) {
        ...
        return (shipment.sender, shipment.receiver, shipment.pickupTime, shipment.deliveryTime, shipment.distance, shipment.price,
